...
public:
	...
	class UGlowingButton_12_C*                    Button_0;                                          // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(GlowingButton_12_C_OnClicked__DelegateSignature, bSelected_0) == 0x000000, "Member 'GlowingButton_12_C_OnClicked__DelegateSignature::bSelected_0' has a wrong offset!");
static_assert(offsetof(GlowingButton_12_C_OnClicked__DelegateSignature, Button_0) == 0x000008, "Member 'GlowingButton_12_C_OnClicked__DelegateSignature::Button_0' has a wrong offset!");
...
static_assert(offsetof(GlowingButton_12_C_OnHover__DelegateSignature, bHovered_0) == 0x000000, "Member 'GlowingButton_12_C_OnHover__DelegateSignature::bHovered_0' has a wrong offset!");
