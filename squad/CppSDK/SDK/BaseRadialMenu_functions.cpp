...
// class UBaseRadialMenu_C*                Context_0                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBaseRadialMenu_C::OnOptionClicked__DelegateSignature(int32 OptionIndex, class UBaseRadialMenu_C* Context_0)
{
...
void UBaseRadialMenu_C::OnCenterClicked__DelegateSignature(class UBaseRadialMenu_C* Context_0)
{
	static class UFunction* Func = nullptr;
