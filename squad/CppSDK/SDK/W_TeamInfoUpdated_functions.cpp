...
// (Public, Delegate, BlueprintCallable, BlueprintEvent)
// Parameters:
// class USQFactionSetup*                  FactionSetup_0                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                                   TeamId                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UW_TeamInfoUpdated_C::TeamInfoSelected__DelegateSignature(class USQFactionSetup* FactionSetup_0, int32 TeamId)
{
	static class UFunction* Func = nullptr;
	...
	Parms.FactionSetup_0 = FactionSetup_0;
	Parms.TeamId = TeamId;
