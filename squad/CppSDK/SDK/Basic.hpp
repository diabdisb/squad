...
namespace Offsets
{
	constexpr int32 GObjects          = 0x071CF4C0;
	constexpr int32 AppendString      = 0x021A1850;
	constexpr int32 GNames            = 0x07192F40;
	constexpr int32 GWorld            = 0x07313CA0;
	constexpr int32 ProcessEvent      = 0x023F19D0;
