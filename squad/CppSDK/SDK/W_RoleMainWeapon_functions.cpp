...
// Parameters:
// class USQRoleSettings*                  Role_0                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UW_RoleMainWeapon_C::SubRole_Pressed__DelegateSignature(class USQRoleSettings* Role_0)
{
...
void UW_RoleMainWeapon_C::SubRole_Hovered__DelegateSignature(class USQRoleSettings* Role_0)
{
	static class UFunction* Func = nullptr;
