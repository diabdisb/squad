...
public:
	...
	float                                         Required_Close_Angle__0Minus1_;                    // 0x0328(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         Required_Far_Angle__0Minus0_9999_;                 // 0x032C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(UUMG_NameTag_C, Required_Close_Angle__0Minus1_) == 0x000328, "Member 'UUMG_NameTag_C::Required_Close_Angle__0Minus1_' has a wrong offset!");
static_assert(offsetof(UUMG_NameTag_C, Required_Far_Angle__0Minus0_9999_) == 0x00032C, "Member 'UUMG_NameTag_C::Required_Far_Angle__0Minus0_9999_' has a wrong offset!");
