...
{
public:
	struct FModdingRuntimeModInfoDetails          ModInfo_0;                                         // 0x0000(0x00A0)(BlueprintVisible, BlueprintReadOnly, Parm)
};
...
static_assert(offsetof(ModItem_C_Mod_Selected__DelegateSignature, ModInfo_0) == 0x000000, "Member 'ModItem_C_Mod_Selected__DelegateSignature::ModInfo_0' has a wrong offset!");
