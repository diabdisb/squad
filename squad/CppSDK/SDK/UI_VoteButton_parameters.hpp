...
{
public:
	class FName                                   VoteId_0;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(UI_VoteButton_C_VoteSelected__DelegateSignature, VoteId_0) == 0x000000, "Member 'UI_VoteButton_C_VoteSelected__DelegateSignature::VoteId_0' has a wrong offset!");
