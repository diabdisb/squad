...
{
public:
	class FName                                   ChoiceId_0;                                        // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(UMG_VoteItem_C_InfoSelected__DelegateSignature, ChoiceId_0) == 0x000000, "Member 'UMG_VoteItem_C_InfoSelected__DelegateSignature::ChoiceId_0' has a wrong offset!");
