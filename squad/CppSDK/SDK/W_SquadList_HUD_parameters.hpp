...
static_assert(offsetof(W_SquadList_HUD_C_OnToggledOpen__DelegateSignature, bIsOpen_0) == 0x000000, "Member 'W_SquadList_HUD_C_OnToggledOpen__DelegateSignature::bIsOpen_0' has a wrong offset!");
