...
// class UMaterialInterface*               WaterLine_0                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_Ocean_C::Set_MIDs(class UMaterialInterface* OceanSurface, class UMaterialInterface* WaterLine_0)
{
	static class UFunction* Func = nullptr;
