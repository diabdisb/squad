...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FBlueprintSessionResult          Friends_Session_0                                      (BlueprintVisible, BlueprintReadOnly, Parm)

void UFriendListItem_C::Set_Session(const struct FBlueprintSessionResult& Friends_Session_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Friends_Session_0 = std::move(Friends_Session_0);
