...
public:
	void OnOptionClicked__DelegateSignature(int32 OptionIndex, class UBaseRadialMenu_C* Context_0);
	void OnCenterClicked__DelegateSignature(class UBaseRadialMenu_C* Context_0);
