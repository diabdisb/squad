...
void USettingsItem_Slider_LR_C::OnValueChanged__DelegateSignature(float Value_0)
{
...
void USettingsItem_Slider_LR_C::OnCaptureEnd__DelegateSignature(float Value_0)
{
	static class UFunction* Func = nullptr;
