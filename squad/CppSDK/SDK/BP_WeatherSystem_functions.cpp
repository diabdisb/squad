...
// Parameters:
// float                                   CeilingHeight_0                                        (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// float                                   RoomWidth_0                                            (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// float                                   RoomLenght_0                                           (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// EPhysicalSurface                        FloorType                                              (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_WeatherSystem_C::DrawRoom(float* CeilingHeight_0, float* RoomWidth_0, float* RoomLenght_0, EPhysicalSurface* FloorType)
{
	static class UFunction* Func = nullptr;
	...
	if (CeilingHeight_0 != nullptr)
		*CeilingHeight_0 = Parms.CeilingHeight_0;

	if (RoomWidth_0 != nullptr)
		*RoomWidth_0 = Parms.RoomWidth_0;

	if (RoomLenght_0 != nullptr)
		*RoomLenght_0 = Parms.RoomLenght_0;
