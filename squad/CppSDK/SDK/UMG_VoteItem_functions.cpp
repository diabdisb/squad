...
// (Public, Delegate, BlueprintCallable, BlueprintEvent)
// Parameters:
// class FName                             ChoiceId_0                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UUMG_VoteItem_C::InfoSelected__DelegateSignature(class FName ChoiceId_0)
{
	static class UFunction* Func = nullptr;
