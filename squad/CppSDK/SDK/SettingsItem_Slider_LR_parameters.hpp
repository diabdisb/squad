...
static_assert(offsetof(SettingsItem_Slider_LR_C_OnValueChanged__DelegateSignature, Value_0) == 0x000000, "Member 'SettingsItem_Slider_LR_C_OnValueChanged__DelegateSignature::Value_0' has a wrong offset!");
...
static_assert(offsetof(SettingsItem_Slider_LR_C_OnCaptureEnd__DelegateSignature, Value_0) == 0x000000, "Member 'SettingsItem_Slider_LR_C_OnCaptureEnd__DelegateSignature::Value_0' has a wrong offset!");
